...
import com.alphadevs.test.domain.Post;
import com.alphadevs.test.repository.PostRepository;
import com.alphadevs.test.repository.search.PostSearchRepository;
...
public class PostResourceIntTest {
    ...
    public void createPost() throws Exception {
        ...
        assertThat(testPost.getDetails()).isEqualTo(DEFAULT_DETAILS);
    ...
    public void updatePost() throws Exception {
        ...
        assertThat(testPost.getDetails()).isEqualTo(UPDATED_DETAILS);
